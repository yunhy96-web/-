...
import ClovaSpringBoot.service.BlogService;
...
public class PlanApiController {
    ...
    public ResponseEntity<Plan> findPlan(@PathVariable long id){
        try {
            Plan plan = blogService.findById(id);
    ...
    public ResponseEntity<Plan> updateArticle(@PathVariable long id,
        ...
        Plan updatedPlan = blogService.update(id, request);
